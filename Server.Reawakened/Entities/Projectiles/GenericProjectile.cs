...
public class GenericProjectile : BaseProjectile
{
                ...
                null, false, serverConfig)
    {
        ...
        Collider = new AttackCollider(id, _hitboxPosition, new Rect(0, 0, config.ProjectileWidth, config.ProjectileHeight), PrjPlane, player, damage, damageType, LifeTime, 0);
