...
public class EnemyBomber(Room room, string entityId, BaseComponent baseEntity) : Enemy(room, entityId, baseEntity)
{
    ...
    public override void HandleAggro()
    {
        ...
        {
            Room.SendSyncEvent(SyncBuilder.AIDo(Entity, Position, 1.0f, BehaviorList.IndexOf("Bomber"), string.Empty, AiData.Sync_TargetPosX, AiData.Sync_TargetPosY,
