...
public class TriggerableTargetCollider(string gameObjectId, Vector3Model position,
    float sizeX, float sizeY, string plane, Room room) :
    BaseCollider(new ColliderModel(plane, position.X, position.Y, sizeX, sizeY), room)
{
