...
internal class AIBehavior_ComeBack : AIBaseBehavior
{
    ...
    public AIBehavior_ComeBack(float attackSpeed, float moveBeyondTargetDistance, bool stayOnPatrolPath, float attackBeyondPatrolLine, float detectionHeightUp, float detectionHeightDown)
    {
