...
public class AIStateGlobalInteractionActiveComp : BaseAIState<AIStateGlobalInteractionActive, AI_State>
{
    public override string StateName => "AIStateGlobalInteractionActive";
    ...
    public override void OnAIStateIn()
    {
        ...
        _globalInteractionEventState.CurrentState = GlobalInteractionStateMachineState.Active;
