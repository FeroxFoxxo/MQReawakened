...
public class GrenadierState(GrenadierProperties properties, List<EnemyResourceModel> resources) : BaseState(resources)
{
    public override AIBaseBehavior GetBaseBehaviour(BehaviorEnemy enemy) =>
        new AIBehaviorGrenadier(enemy, properties);
}
