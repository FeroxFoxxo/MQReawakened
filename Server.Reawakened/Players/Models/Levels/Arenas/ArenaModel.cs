...
public class ArenaModel
{
    ...
    public bool ArenaActivated { get; set; }
    ...
    public void FinishMinigame(int minigameId, Player player)
    {
    ...
    public static string GrantRandomItemLoot(InternalLoot lootCatalog, int arenaId)
    {
